...
for (i in seq_len(nrow(out))) {
  ...
  detail_html <- c(
    ...
    "    const fRaw = elFile && elFile.files && elFile.files[0] ? elFile.files[0] : null;",
    "    if (!fRaw){ elUpStatus.textContent = 'Bitte Datei ausw\u00e4hlen.'; return; }",
    ...
    "    let f = fRaw;",
    "    try {",
    "      elUpStatus.textContent = 'Bild wird komprimiert...';",
